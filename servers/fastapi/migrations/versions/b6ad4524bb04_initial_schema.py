...
Revision ID: b6ad4524bb04
Revises: 
Create Date: 2026-02-07 16:49:17.234080
...
import db.types.guid


# revision identifiers, used by Alembic.
revision: str = 'b6ad4524bb04'
...
def upgrade() -> None:
    ...
    sa.Column('id', db.types.guid.GUID(), nullable=False),
    sa.Column('status', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('message', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('presentation_id', db.types.guid.GUID(), nullable=True),
