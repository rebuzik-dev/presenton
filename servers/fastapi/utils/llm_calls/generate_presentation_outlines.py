...
def get_system_prompt(
    ...
    system = (
        ...
        "Populate image_style with one shared art direction for the whole deck whenever the content contains visual or template direction. "
        "Capture visual genre, mood, lighting, composition, palette and consistency rules; do not return null when those directions are available.\n"
        "For each slide that benefits from an image, set image_prompt to a concrete project-specific subject, action, setting and camera/composition intent. "
        "Keep slide subjects distinct, inherit the shared image_style, avoid generic filler, production-file specifications, logos, readable text, and literal None/null/N/A suffixes.\n"
