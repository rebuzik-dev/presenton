...
const layoutDescription =
  "Вторая флористическая точка контакта: общий вид и связанный ракурс или деталь композиции. Формат и расположение определять только по брифу."
...
const Schema = z.object({
  title: z
    ...
    .min(5)
    .max(80)
    .default("ФЛОРИСТИЧЕСКАЯ ТОЧКА КОНТАКТА")
    .meta({
      description:
      ...
      <div className="h-full px-[56px] pt-[42px] pb-[42px]">
        ...
        <div
          {...promptTargetAttrs({
            ...
            type: "field",
            name: "Title",
            description: "Заголовок второй флористической точки контакта",
          })}
          className="uppercase font-[900] text-[44px] leading-[52px]"
          style={{ color: titleColor, fontFamily: titleFont }}
        >
          {slideData?.title || "ФЛОРИСТИЧЕСКАЯ ТОЧКА КОНТАКТА"}
        </div>
