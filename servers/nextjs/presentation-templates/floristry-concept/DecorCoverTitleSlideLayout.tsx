...
const layoutDescription = "Обложка концепции флористического направления: тип документа и точное название мероприятия только из брифа."
...
const Schema = z.object({
  documentType: z
    ...
    .min(5)
    .max(50)
    .default("Концепция флористики")
    .meta({
      description:
        "Тип документа из брифа или контекста: концепция флористического направления. Не добавлять дату, тему, площадку и формат без основания.",
    }),
  eventName: z
    .string()
    .min(5)
