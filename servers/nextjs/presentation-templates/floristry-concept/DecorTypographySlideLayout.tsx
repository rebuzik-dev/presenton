...
const layoutDescription =
  "Типографика и подписи в системе флористики: применение на карточках композиций, навигации или другом релевантном носителе только при наличии такого носителя в брифе.";
