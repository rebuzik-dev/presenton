...
const layoutDescription =
  "Два согласованных варианта состава подарочного набора: компоненты из брифа либо уместные предложения для получателя, повода и бюджета."
...
const LabeledImageSchema = z.object({
  ...
  image: ImageSchema.default({
    ...
    __image_prompt__: "Компонент подарочного набора или упаковка, связанная с подписью и требованиями брифа",
  }).meta({ description: "Изображение конкретного компонента; второй кадр должен показывать другой компонент или функцию." }),
})
...
const Schema = z.object({
  ...
  images: z
    ...
    .default([
      ...
      { label: "Упаковка", image: { __image_url__: "https://images.pexels.com/photos/31527637/pexels-photo-31527637.jpeg", __image_prompt__: "Упаковка или комплектование подарочного набора в согласованной визуальной системе" } },
    ])
            ...
            <div key={idx} className="relative overflow-hidden bg-[var(--style-surface)]" style={{ backgroundColor: surfaceColor }}>
              <img
                {...promptTargetAttrs({
                  ...
                  description: "Отдельный компонент или часть упаковки подарочного набора",
                })}
