...
const ImageSchema = z.object({
  ...
  __image_prompt__: z
    ...
    .min(3)
    .max(180)
    .default("Компоненты подарочного набора, материалы или упаковка, показывающие применение палитры из брифа")
    .meta({ description: "Кадр применения палитры на компонентах, материалах или упаковке без случайного текста и логотипов." }),
})
...
const layoutDescription =
  "Палитра подарочного набора: фирменные цвета из брифа либо обоснованное сочетание для получателя, компонентов и упаковки."
...
const Schema = z.object({
  ...
  primary: z
    ...
    .meta({
      description:
        "Три основных цвета: сначала точные брендовые значения из брифа, иначе обоснованная палитра для подарочного набора.",
    }),
  secondary: z
    .array(ColorCardSchema)
    .min(3)
  ...
  image: ImageSchema.default({
    ...
    __image_prompt__: "Компоненты подарочного набора, материалы или упаковка из концепции, на которых заметно применение выбранной палитры",
  }).meta({ description: "Изображение демонстрирует палитру на компонентах, материале или упаковке выбранного подарочного набора." }),
})
