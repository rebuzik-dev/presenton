...
const ImageSchema = z.object({
  ...
  __image_prompt__: z
    ...
    .min(3)
    .max(180)
    .default("Фирменный паттерн для подарочного набора, собранный из визуальных мотивов брифа")
...
const layoutDescription =
  "Фирменный паттерн подарочного набора: принцип построения, связь с концепцией и применение на компонентах или упаковке."
...
const Schema = z.object({
  ...
  description: z
    ...
    .max(260)
    .default(
      "Паттерн развивает визуальную идею мероприятия и масштабируется на компоненты набора, упаковку и сопроводительные материалы."
    )
  ...
  image: ImageSchema.default({
    ...
    __image_prompt__: "Модульный фирменный паттерн для подарочного набора, основанный на формах, ритме и настроении из брифа",
