...
const ImageSchema = z.object({
  ...
  __image_prompt__: z
    ...
    .min(3)
    .max(180)
    .default("Типографика на компоненте подарочного набора, упаковке или сопроводительном носителе из брифа")
...
const layoutDescription =
  "Типографическая система подарочного набора и её применение на компонентах, упаковке или сопроводительном носителе."
...
const Schema = z.object({
  ...
  image: ImageSchema.default({
    ...
    __image_prompt__: "Крупный кадр компонента подарочного набора, упаковки или карточки с аккуратным применением выбранной типографики",
  }).meta({ description: "Носитель типографики должен относиться к подарочному набору и соответствовать его назначению." }),
})
