...
const ImageSchema = z.object({
  ...
  __image_prompt__: z.string().min(3).max(220).default("Визуальный элемент подарочного набора").meta({
    description: "Кадр компонента, материала, упаковки или всего набора на основе брифа; без случайного текста и неподтверждённого брендинга.",
  }),
});
...
const layoutDescription =
  "Материалы, отделка и брендинг подарочного набора: два текстовых блока, детальный кадр компонента и общий вид набора.";

const Schema = z.object({
  title: z.string().min(3).max(60).default("МАТЕРИАЛЫ И ОТДЕЛКА").meta({
    description: "Заголовок раздела о материалах, производстве, упаковке и визуальных деталях подарочного набора.",
  }),
  ...
  topText: z
    ...
    .min(10)
    .max(260)
    .default("Материалы и технологии выбираются по назначению компонентов, сценарию вручения, сроку использования и ограничениям производства.")
  ...
  topImage: ImageSchema.default({
    ...
    __image_prompt__: "Крупный план материала, фактуры, шва, печати, гравировки или другой отделки компонента подарочного набора",
  }),

  bottomImage: ImageSchema.default({
    __image_url__: "https://images.pexels.com/photos/31527637/pexels-photo-31527637.jpeg",
    __image_prompt__: "Общий вид подарочного набора, показывающий согласованность компонентов, материалов, цветов, упаковки и брендинга",
  }),
});
