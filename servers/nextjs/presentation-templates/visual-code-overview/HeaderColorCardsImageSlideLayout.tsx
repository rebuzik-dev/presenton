...
const ImageSchema = z.object({
  ...
  __image_prompt__: z
    ...
    .min(3)
    .max(180)
    .default("Сцена мероприятия, показывающая применение палитры в пространстве, материалах и коммуникационных носителях")
    .meta({ description: "Поддерживающий кадр палитры: показать её на релевантных объектах мероприятия без случайного текста и логотипов." }),
})
...
const layoutDescription =
  "Палитра визуального кода: использовать фирменные цвета из брифа, а при их отсутствии предложить сочетание под формат, аудиторию и атмосферу мероприятия."
...
const ColorCardSchema = z.object({
  ...
  description: z.string().min(6).max(70).default("Роль цвета в визуальной системе").meta({ description: "Практическая роль цвета: фон, навигация, текстиль, конструкция, графика или акцент." }),
...
const Schema = z.object({
  ...
  colorCards: z
    ...
    .max(8)
    .default([
      { hex: "#F2EFE8", description: "Светлая база для пространства и носителей", group: "primary" },
      { hex: "#3F474B", description: "Основной контраст для текста и конструкций", group: "primary" },
      { hex: "#B58A56", description: "Тёплый акцент для деталей и навигации", group: "primary" },
      { hex: "#D6C7B5", description: "Поддерживающий оттенок материалов", group: "secondary" },
      { hex: "#6D7A70", description: "Дополнительный природный акцент", group: "secondary" },
  ...
  image: ImageSchema.default({
    ...
    __image_prompt__: "Пространство, материалы и коммуникационные носители мероприятия, демонстрирующие выбранную палитру",
