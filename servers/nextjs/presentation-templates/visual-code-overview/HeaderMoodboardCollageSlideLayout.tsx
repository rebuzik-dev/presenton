...
const ImageSchema = z.object({
  ...
  __image_prompt__: z
    ...
    .min(3)
    .max(180)
    .default("Кадр общей визуальной системы мероприятия на основе брифа")
    .meta({ description: "Один самостоятельный кадр мудборда визуального кода. Не повторять композицию соседних слотов." }),
})
...
const IconSchema = z.object({
  ...
  __icon_prompt__: z
    ...
    .min(1)
    .max(60)
    .default("иконка визуального мудборда")
...
const layoutDescription =
  "Четырёхкадровый мудборд визуального кода: пространство, коммуникационный носитель, деталь и материалы в едином стиле."
...
const Schema = z.object({
  title: z
    ...
    .max(20)
    .default("МУДБОРД")
    .meta({ description: "Короткий заголовок мудборда визуального кода." }),
  images: z
    .array(ImageSchema)
    .min(4)
    .max(4)
    .default([
      { __image_url__: "https://images.pexels.com/photos/31527637/pexels-photo-31527637.jpeg", __image_prompt__: "Общий вид визуальной системы в контексте площадки и формата мероприятия" },
      { __image_url__: "https://images.pexels.com/photos/587741/pexels-photo-587741.jpeg", __image_prompt__: "Коммуникационный носитель или навигация в естественном сценарии мероприятия" },
      { __image_url__: "https://images.pexels.com/photos/1024960/pexels-photo-1024960.jpeg", __image_prompt__: "Крупный план графической детали, фактуры или типографического приёма" },
      { __image_url__: "https://images.pexels.com/photos/31527637/pexels-photo-31527637.jpeg", __image_prompt__: "Материалы, поверхности и бренд-акценты визуальной системы без случайного текста" },
    ])
