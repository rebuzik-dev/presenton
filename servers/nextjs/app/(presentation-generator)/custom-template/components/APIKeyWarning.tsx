      ...
      <div className="flex items-center justify-center aspect-video mx-auto px-6">
        <div className="text-center space-y-2 my-6 bg-white p-10 rounded-lg shadow-lg">
          <h1 className="text-xl font-bold text-gray-900">
            Please add "TEMPLATE_API_KEY" to enable template creation via AI.
          </h1>
          <h1 className="text-xl font-bold text-gray-900">Please configure your AI Model settings</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            This feature requires a configured TEMPLATE_MODEL. Configure your key in settings or via environment variables.
          </p>
        </div>
      </div>
    </div>
