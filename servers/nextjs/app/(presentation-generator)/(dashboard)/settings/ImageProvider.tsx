                                        ...
                                        (() => {
                                            ...
                                            if (provider.value === "custom_openai" || provider.value === "vsellm") {
                                                return (
                                                    <OpenAICompatibleImageFields
                                                        layout="textProviderSettings"
                                                        baseUrl={llmConfig.IMAGE_GEN_BASE_URL || ""}
                                                        apiKey={llmConfig.IMAGE_GEN_API_KEY || ""}
                                                        model={llmConfig.IMAGE_GEN_MODEL || ""}
                                                        onBaseUrlChange={(v) => {
                                                            setLlmConfig((prev: any) => ({ ...prev, IMAGE_GEN_BASE_URL: v }));
                                                        }}
                                                        onApiKeyChange={(v) => {
                                                            setLlmConfig((prev: any) => ({ ...prev, IMAGE_GEN_API_KEY: v }));
                                                        }}
                                                        onModelChange={(v) => {
                                                            setLlmConfig((prev: any) => ({ ...prev, IMAGE_GEN_MODEL: v }));
                                                        }}
                                                    />
                                                );
                                            }
