...
export default function TemplatePromptEditorPage() {
        ...
        return (
            <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6">
                <div className="flex flex-col items-center space-y-4 max-w-sm text-center">
                    ...
                    <h3 className="text-xl font-bold text-gray-900">Loading prompt profile</h3>
    ...
    if (!data) {
        return (
            <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6">
                <div className="max-w-md text-center bg-white p-8 rounded-3xl border border-gray-200 shadow-sm">
                    <AlertCircle className="w-12 h-12 text-red-500 mx-auto mb-4" />
                    <h3 className="text-lg font-bold text-gray-900 mb-2">Template not found</h3>
    ...
    return (
        <div className="min-h-screen bg-gray-50 pb-24 font-syne">
            {/* Sticky Header */}
                            ...
                            {filteredLayouts.map((layout) => {
                                ...
                                return (
                                    <Card
                                        ...
                                        className="rounded-[24px] border border-gray-200 bg-white overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-200"
                                    >
                                        ...
                                        <CardContent className="p-6 space-y-6">
                                            ...
                                            <Accordion type="single" collapsible className="w-full border border-gray-100 rounded-2xl overflow-hidden">

                                                {/* Text Fields Accordion Section */}
                                                {stringFields.length > 0 && (
                                                    <AccordionItem value="fields" className="border-b border-gray-100 px-4">
