...
const allGroups = {
  ...
  souvenir: {
    dir: "souvenir",
    files: {
      "CoverBackgroundKickerTitleSlideLayout.tsx": [
        /promptTargetAttrs/,
        /path:\s*["']background\.__image_prompt__["']/,
        /path:\s*["']kicker["']/,
        /path:\s*["']title["']/,
      ],
      "HeaderQuoteTwoColumnsLinesSlideLayout.tsx": [
        /promptTargetAttrs/,
        /path:\s*["']title["']/,
        /path:\s*["']quote["']/,
        /path:\s*["']leftTitle["']/,
      ...
      "PaletteGridImageSlideLayout.tsx": [
        /promptTargetAttrs/,
        /path:\s*["']title["']/,
        /path:\s*["']leftHeader["']/,
        /path:\s*["']rightHeader["']/,
        /\$\{pathPrefix\}\[\$\{index\}\]\.hex/,
        /\$\{pathPrefix\}\[\$\{index\}\]\.name/,
        /pathPrefix="primary"/,
        /pathPrefix="secondary"/,
        /path:\s*["']image\.__image_prompt__["']/,
      ],
      "TypographyTwoColumnsImageSlideLayout.tsx": [
        /promptTargetAttrs/,
        /path:\s*["']title["']/,
        /path:\s*["']leftTitle["']/,
        /leftBullets\[\$\{idx\}\]/,
      ...
      "MoodboardCollage4SlideLayout.tsx": [
        /promptTargetAttrs/,
        /path:\s*["']title["']/,
        /images\[\$\{0\}\]\.__image_prompt__/,
        /images\[\$\{1\}\]\.__image_prompt__/,
      ...
      "HeaderParagraphPatternImageSlideLayout.tsx": [
        /promptTargetAttrs/,
        /path:\s*["']title["']/,
        /path:\s*["']description["']/,
        /path:\s*["']image\.__image_prompt__["']/,
      ],
      "DesignElementsMultiColumnSlideLayout.tsx": [
        /promptTargetAttrs/,
        /path:\s*["']title["']/,
        /path:\s*["']imageTopLeft\.__image_prompt__["']/,
        /path:\s*["']imageTopRight\.__image_prompt__["']/,
        /path:\s*["']imageBottom\.__image_prompt__["']/,
        /path:\s*["']topText["']/,
        /path:\s*["']bottomText["']/,
      ],
      "DesignElementsTextImageSwatchesSlideLayout.tsx": [
        /promptTargetAttrs/,
        /path:\s*["']title["']/,
        /path:\s*["']topText["']/,
        /path:\s*["']bottomText["']/,
        /path:\s*["']topImage\.__image_prompt__["']/,
        /path:\s*["']bottomImage\.__image_prompt__["']/,
      ],
      "ProposalsTwoImagesSlideLayout.tsx": [
        /promptTargetAttrs/,
        /path:\s*["']titlePrefix["']/,
        /path:\s*["']blockName["']/,
        /tags\[\$\{idx\}\]/,
        /images\[\$\{idx\}\]\.label/,
        /images\[\$\{idx\}\]\.image\.__image_prompt__/,
      ],
      "ProposalsThreeImagesSlideLayout.tsx": [
        /promptTargetAttrs/,
        /path:\s*["']titlePrefix["']/,
        /path:\s*["']blockName["']/,
        /images\[\$\{idx\}\]\.label/,
      ...
      "ProposalsCollageLeftRightStackSlideLayout.tsx": [
        /promptTargetAttrs/,
        /path:\s*["']titlePrefix["']/,
        /path:\s*["']blockName["']/,
        /path:\s*["']left\.label["']/,
        /path:\s*["']left\.image\.__image_prompt__["']/,
        /path:\s*["']rightTop\.label["']/,
        /path:\s*["']rightTop\.image\.__image_prompt__["']/,
        /path:\s*["']rightBottom\.label["']/,
        /path:\s*["']rightBottom\.image\.__image_prompt__["']/,
      ],
    },
  },
};
